...
│       │       │               ├── controller
│       │       │               │   ├── WebExeRoom.java               //web exe 后台协议总入口
│       │       │               │   └── WebRTCRoom.java               //webrtc后台协议总入口
│       │       │               ├── logic
│       │       │               │   ├── IMMgr.java                    //云通信逻辑实现
│       │       │               │   └── RoomMgr.java                  //房间管理实现
│       │       │               ├── pojo
...
│       │       │               │   │   ├── DeleteRoomReq.java        //删除请求定义，web exe特有
...
│       │       │               │   └── Room.java                     //房间结构定义
│       │       │               ├── service
│       │       │               │   ├── RoomService.java              //房间管理服务service实现
│       │       │               │   └── impl
│       │       │               │       └── RoomServiceImpl.java      //房间管理服务service接口
│       │       │               └── utils
